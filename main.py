...
def BillyToBitrix(ProspectiveSales):
    ...
    # Дополниельне поля сделки в случае если ПП завершена
    ...
    if bitrix.result.json()['total']:
        ...
        dealId = bitrix.result.json()['result'][0]['ID']
    else:
        method = "add"
